...
test('MOD-022: Acepta apelación y restaura publicación', function () {
...
test('MOD-023: Rechaza apelación y mantiene publicación oculta', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
    $case = createModerationCase($publication, [
        'status' => 'appealed',
        'assigned_moderator_id' => $this->moderator->id,
...
test('MOD-024: Valida campos requeridos', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
    $case = createModerationCase($publication, [
        'status' => 'appealed',
        'assigned_moderator_id' => $this->moderator->id,
...
test('MOD-025: Valida que final_decision sea uphold u overturn', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
    $case = createModerationCase($publication, [
        'status' => 'appealed',
        'assigned_moderator_id' => $this->moderator->id,
...
test('MOD-026: No permite revisar si canReviewAppeal es false', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
    $case = createModerationCase($publication, [
        'status' => 'appealed',
        'assigned_moderator_id' => $this->moderator->id,
...
test('MOD-027: No permite revisar apelación que no pertenece al caso', function () {
...
test('MOD-028: No permite revisar apelación ya revisada', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
    $case = createModerationCase($publication, [
        'status' => 'appealed',
        'assigned_moderator_id' => $this->moderator->id,
...
test('MOD-029: Retorna estadísticas de apelaciones', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
...
test('MOD-030: getAppealStats cubre todas las ramas SQL', function () {
...
test('MOD-031: Retorna solo apelaciones pendientes asignadas al moderador', function () {
    $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
