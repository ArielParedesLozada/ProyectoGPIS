...
describe('Asignación de casos', function () {
    beforeEach(function () {
    ...
    it('MOD-ASSIGN-001: Moderador puede asignarse un caso no asignado', function () {
    ...
    it('MOD-ASSIGN-002: Moderador puede asignarse un caso ya asignado a él mismo', function () {
        $publication = createTestPublication($this->vendor, $this->category);
        $case = createModerationCase($publication, [
    ...
    it('MOD-ASSIGN-003: No puede asignarse un caso ya asignado a otro moderador', function () {
        $publication = createTestPublication($this->vendor, $this->category);
        $case = createModerationCase($publication, [
    ...
    it('MOD-ASSIGN-004: Puede asignarse un caso de apelación no asignado', function () {
    ...
    it('MOD-ASSIGN-005: assignAppealCase asigna caso de apelación no asignado', function () {
        $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
        $case = createModerationCase($publication, [
            'status' => 'appealed',
            'assigned_moderator_id' => null,
    ...
    it('MOD-ASSIGN-006: assignAppealCase rechaza caso que no es apelación', function () {
        $publication = createTestPublication($this->vendor, $this->category);
    ...
    it('MOD-ASSIGN-007: assignAppealCase rechaza caso ya asignado', function () {
        $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
        $case = createModerationCase($publication, [
            'status' => 'appealed',
            'assigned_moderator_id' => $this->anotherModerator->id,
    ...
    it('MOD-ASSIGN-008: getMyReportCases retorna solo casos de reportes asignados al moderador', function () {
        $publication = createTestPublication($this->vendor, $this->category);
    ...
    it('MOD-ASSIGN-009: getMyAppealCases retorna solo casos de apelaciones asignados al moderador', function () {
        $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
        $case1 = createModerationCase($publication, [
            'status' => 'appealed',
            'assigned_moderator_id' => $this->moderator->id,
    ...
    it('MOD-ASSIGN-010: canAccessCase retorna false para apelación de propia decisión', function () {
        $publication = createTestPublication($this->vendor, $this->category, ['is_hidden' => true]);
        $case = createModerationCase($publication, [
            'status' => 'appealed',
            'assigned_moderator_id' => $this->moderator->id,
    ...
    it('MOD-ASSIGN-011: canAccessCase retorna false para caso no asignado al moderador', function () {
        $publication = createTestPublication($this->vendor, $this->category);
        $case = createModerationCase($publication, [
            'assigned_moderator_id' => $this->anotherModerator->id,
        ]);
    ...
    it('MOD-ASSIGN-012: canAccessCase retorna true para caso asignado correctamente', function () {
        $publication = createTestPublication($this->vendor, $this->category);
        $case = createModerationCase($publication, [
            'assigned_moderator_id' => $this->moderator->id,
        ]);
