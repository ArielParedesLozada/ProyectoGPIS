...
class ProfanityService
{
    protected $basicWords = [
        ...
        'hijo de puta', 'hijoputa', 'coño', 'carajo', 'verga', 'sexo', 'fuck',
        'sex', 'sexual', 'porn', 'porno', 'xxx', 'adult', 'adulto', 'nude',
        'desnudo', 'desnuda', 'naked', 'nude', 'xxx', 'pornografia', 'pornografía'
    ];
    
    public function __construct()
    {
        // No initialization needed - using native PHP detection
    }
    ...
    /**
     * Clean text by replacing profane words
     */
    public function cleanText(string $text): string
    {
        ...
        foreach ($this->basicWords as $word) {
            if (strpos($textLower, $word) !== false) {
                $cleanedText = str_ireplace($word, str_repeat('*', strlen($word)), $cleanedText);
            }
        }
    ...
    public function getStats(): array
    {
        return [
            ...
            'whitelist_count' => count(config('profanity.whitelist.es', [])),
        ];
    }
}
