          ...
          <div className="grid gap-6">
            <div className="grid gap-2">
              ...
              <Input
                ...
                readOnly
              />
              <CustomError message={getErrorMessage('validation.email', errors.email)} />
            </div>
            ...
            <div className="grid gap-2">
              ...
              />
              <CustomError message={getErrorMessage('validation.password.confirmed', errors.password_confirmation)} />
            </div>
